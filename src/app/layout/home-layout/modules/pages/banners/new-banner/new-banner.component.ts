...
export class NewBannerComponent {
  ...
  constructor(
    ...
    this.formGroup = this.fb.group({
      ...
      cta_label: [this.data?.cta_label ?? null, [Validators.required]],
      cta_link: [this.data?.cta_link ?? null, [Validators.required]],
  ...
  onSubmit() {
    ...
    if (this.formGroup.valid) {
      ...
      this.apiService.submitBanner(formData).subscribe({
        next: (res: any) => {
