...
export class ProductsComponent {
  ...
  ngOnInit(): void {
    if (this.helperService.can('products.export')) this.helperService.setExportAction({ label: 'Export', icon: 'download' });
  ...
  get permissions(): string[] { return this.access.actions('products'); }
  checkPermission() {
