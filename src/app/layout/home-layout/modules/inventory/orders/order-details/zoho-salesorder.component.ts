...
@Component({
  ...
  template: `<section class="rounded-lg border bg-white p-5 mb-6" *ngIf="canManage">
    <h3 class="text-lg font-semibold">Zoho Books Customer</h3>
  ...
  <section class="rounded-lg border bg-white p-5 mb-6" *ngIf="canManage && state">
