...
import { NewClassificationComponent } from './new-classification/new-classification.component';
...
export class ClassificationComponent {
  ...
  addItem(data: any = null) {
    this.dialog
      .open(NewClassificationComponent, {
        data: data,
        disableClose: true,
      })
      .afterClosed()
  ...
  deleteItem(item: any) {
    this.inventoryService.deleteClassification({ _id: item._id }).subscribe({
      next: (res: any) => {
  ...
  get permissions(): string[] { return this.access.actions('classification'); }
  checkPermission() {
